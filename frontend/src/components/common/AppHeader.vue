    ...
    columns: [
      {
        ...
        cta: { text: 'Explore Research', to: '/student/industry' },
      },
      {
        type: 'links',
        title: 'Our Research',
        links: [
          { label: 'Our Performance', to: '/student/industry#performance' },
          { label: 'Find A Researcher', to: '/student/industry#researchers' },
          { label: 'Research Institutes', to: '/student/industry#institutes' },
          { label: 'Research Centres', to: '/student/industry#centres' },
          { label: 'Research Facilities & Precincts', to: '/student/industry#facilities' },
        ],
      },
      {
        type: 'links',
        title: 'Connect',
        links: [
          { label: 'Partner With Us', to: '/student/industry#partners' },
          { label: 'Industry Partners', to: '/student/industry' },
          { label: 'Career Outcomes', to: '/explore/careers' },
          { label: 'Career Pathways', to: '/explore/careers#pathways' },
        ],
      },
      {
        type: 'links',
        ...
        links: [
          { label: 'Graduate Research School', to: '/explore?level=research' },
          { label: 'Research Technology Support', to: '/student/resources#technology' },
        ],
      },
    ],
  },
